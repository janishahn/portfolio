...
export default function ThesisCard({ thesis }: Props) {
  return (
    <Link
      to="/thesis"
      className="block border rounded-lg p-6 hover:shadow transition backdrop-blur-md bg-white/10 dark:bg-white/5 border-white/20 dark:border-white/10 hover:bg-white/15 dark:hover:bg-white/8"
    >
